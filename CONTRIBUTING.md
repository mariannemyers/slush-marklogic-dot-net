# Contributing to slush-marklogic-dotnet

slush-marklogic-dotnet welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use slush-marklogic-dotnet, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with both MarkLogic and Slush.
...
* **slush-marklogic-dotnet Version** - is it a named version or from our master branch
...
#### Fork slush-marklogic-dotnet

Fork the project [on GitHub](https://github.com/mariannemyers/slush-marklogic-dotnet/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/slush-marklogic-dotnet.git
$ cd slush-marklogic-dotnet
$ git remote add upstream git://github.com/mariannemyers/slush-marklogic-dotnet.git
```
...
Go to https://github.com/username/slush-marklogic-dotnet and select your feature branch. Click
...
[wiki]: https://github.com/mariannemyers/slush-marklogic-dotnet/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/mariannemyers/slush-marklogic-dotnet/issues
